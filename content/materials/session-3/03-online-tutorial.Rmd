...
**Exercise**: See what happens when you add `+ theme_minimal()`, `+ theme_void()`, or `+ theme_dag() to the DAG. What package do you think is laying behind the mappings of `ggdag`?
